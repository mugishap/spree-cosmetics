...
public class SwaggerApiDoc extends WebMvcConfigurationSupport {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Spree Cosmetics API").description("Spree Cosmetics APIs Documentation")
                .termsOfServiceUrl("https://github.com/mugishap/spreecosmetics")
                .version("1.0").build();
    }
}
